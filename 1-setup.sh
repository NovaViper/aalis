...
banner ${LIGHT_PURPLE} "Installing Power Management Tools"
while true; do
	read -p "$(output ${YELLOW} "What power management tool do you want to use? [T]LP or [P]ower Profiles Daemon?: ")" battery
	case $battery in
	T | t)
...
export PASSWORD_STORE_DIR="$XDG_CONFIG/pass"
EOF
